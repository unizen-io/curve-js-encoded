...
(function () {
    return __awaiter(this, void 0, void 0, function () {
        var _i, _a, poolName, pool, amounts;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    amounts = pool.underlyingCoinAddresses.map(function () { return '10'; });
                    return [4 /*yield*/, pool.depositAndStake(amounts)];
                case 3:
                    _b.sent();
                    console.log("Deposited LP tokens to ".concat(poolName.toUpperCase(), " gauge"));
                    _b.label = 4;
                case 4:
                    _i++;
                    return [3 /*break*/, 2];
